...
<div class="container mt-5">
    ...
    <form action="{{ route('expenses.update', $expense->id) }}" method="POST" class="mb-4 content-form" hx-post="{{ route('expenses.update', $expense->id) }}" hx-boost="true" hx-target="body" hx-push-url="true">
